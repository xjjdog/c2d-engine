...
public class SnowParticleTest extends Engine {
    @Override
    ...
    private class EngineX implements EngineDrive {
        ...
        public void onLoadedResourcesCompleted() {
            ...
            final ParticleEffectActor actor = new ParticleEffectActor(particleEffect, "snow");
            actor.setPosition(0, Engine.getHeight());
