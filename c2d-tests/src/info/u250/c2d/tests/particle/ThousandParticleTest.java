...
public class ThousandParticleTest extends Engine {
    @Override
    ...
    private class EngineX implements EngineDrive {
        ...
        public void onLoadedResourcesCompleted() {
            ...
            final ParticleEffectActor actor = new ParticleEffectActor(particleEffect, "thousand");
            actor.setPosition(50, Engine.getHeight());
