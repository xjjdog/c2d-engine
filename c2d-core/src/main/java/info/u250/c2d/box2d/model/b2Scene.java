...
public class b2Scene implements java.io.Serializable {
    ...
    public List<b2FixtureDefModel> fixtureDefModels = new ArrayList<>();
    public List<b2BodyDefModel> bodyDefModels = new ArrayList<>();
    public List<b2JointDefModel> jointDefModels = new ArrayList<>();
}
